...
tarteaucitron.services.xandrconversion = {
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        'other=' +
        document.getElementById(uniqIds[i]).getAttribute('xandrconversionOther')
  ...
  js: function () {
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri +=
        ...
        '&'
      uri +=
        'lang=' + document.getElementById(uniqIds[i]).getAttribute('lang') + '&'
      uri +=
      ...
      uri +=
        'aabd=' + document.getElementById(uniqIds[i]).getAttribute('aabd') + '&'
...
tarteaucitron.services.soundcloud = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['soundcloud_player'], function (x) {
      ...
      var qs =
        '?url=https%3A//api.soundcloud.com/' + playable_type + '/' + playable_id
