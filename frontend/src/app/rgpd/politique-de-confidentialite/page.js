    ...
    <div>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Collectées pour des finalités déterminées (cf. Article 3.1) et
            légitimes.
          </li>
          <li>
          ...
          <li>
            Conservées pour une durée n'excédant pas celle nécessaire aux
        ...
        <ul>
          <li>
            La personne concernée a consenti au traitement de ses données pour
            une bonne utilisation du site internet.
          </li>
      ...
      <section>
        ...
        <p>
          ...
          site CultHive sont les suivantes :
        </p>
        <ul>
        ...
        <h3>3.2 : Mode de collecte des données</h3>
        <p>
          Lorsque vous utilisez notre site, nous collectons automatiquement
          certaines informations via des cookies :
        </p>
        <ul>
          <li>Adresse IP</li>
        ...
        <h3>3.3 : Hébergement des données</h3>
        <p>
        ...
        <h3>3.4 : Politique en matière de cookies</h3>
        <p>
          Des cookies sont utilisés pour améliorer l’expérience utilisateur et
          analyser l’activité du site. Vous pouvez gérer vos préférences dans
      ...
      <section>
        ...
        <p>
          ...
          <br />
          Email :{' '}
          <a href="mailto:contact@fictyverse.fr">contact@fictyverse.fr</a>
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          personnelles peut se prévaloir des droits suivants :
        </p>
        <ul>
          <li>
      ...
      <section>
        ...
        <p>
          ...
          moment. Les modifications seront mises à jour sur cette page.
        </p>
      </section>
      <Footer />
    </div>
